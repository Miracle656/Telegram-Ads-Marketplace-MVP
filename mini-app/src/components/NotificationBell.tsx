        ...
        <div className="relative">
            ...
            {showDropdown && (
                <>
                    ...
                    {/* Dropdown */}
                    <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-gray-900 rounded-lg shadow-2xl border border-gray-200 dark:border-gray-700 z-20 max-h-96 overflow-hidden flex flex-col">
                        {/* Header */}
